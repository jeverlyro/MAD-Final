    ...
    <View style={styles.container}>
      <ScrollView style={styles.insideContent}>
        ...
        <Text style={styles.sectionContent2}>
          ...
          users to create one-of-a-kind mechanical keyboards with little effort
          and technical knowledge. It is an excellent and hassle-free way of
          getting into the hobby as you will get to build your keyboard from
          scratch.
        </Text>
        <Gap height={30} />
        ...
        <Text style={styles.sectionContent3}>
          Keycaps are an essential component of any mechanical keyboard,
          providing a personalized touch to your typing experience while
          influencing your setup’s overall aesthetics. There are also many types
          / profiles of keycaps that suitable for a purpose.
        </Text>
        <Gap height={30} />
        ...
        <Text style={styles.sectionContent6}>
          By applying tape between the switch housing and the stem’s rails, the
          tape dampens the stem’s bounce-back after a keypress. It changes the
          sound & feel profile of the switch to be quieter and smoother to type
          on.
        </Text>
        <Gap height={30} />
        ...
        <Text style={styles.miniText2}>
          ...
          barebone. But there’s a keyboard that soldered out the switches to the
          PCB so it can not be pulled.
        </Text>
        ...
        <Text style={styles.miniText2}>
          ...
          aim to give more ejoyable typing feeling, while OEM profile aim for a
          better gaming experience.
        </Text>
        <Text style={styles.Text2}>・Choose your switches</Text>
        <Text style={styles.miniText2}>
          Many people dislike the blue switches because they are known for being
          loud, there’s many type of switches you can choose that will give
          better sounds, for example, yellow switches give you a thocky-like
          sound.
        </Text>
      </ScrollView>
      <Gap height={100} />
